...
const AboutPage = () => {
  return (
    <div className="relative flex flex-col md:flex-row min-h-screen w-full overflow-visible">
      ...
      {/* Fixed About background image, left aligned */}
      <div className="hidden md:block pointer-events-none select-none fixed top-1/2 left-[6vw] -translate-y-1/2 z-0">
        <Image
          src={aboutBackground}
          alt="Framingpixel Monogram"
          priority
          className="w-[45vw] h-auto max-w-none"
          sizes="45vw"
        />
      </div>
